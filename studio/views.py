...
def studio_tickets(request):
    ...
    if request.user.is_authenticated:
        ...
        filtered_tickets = [ticket for ticket in page_obj if
                            ...
                            ticket.has_submitted_outfits(request.user) # ...logged-in user exei hdh kanei submit x (des models.py) outfits se afto
                            # ticket.style1.id in user_styles
                            ] # ...user's studio_styles AFTO ISWS EINAI PROBLEM OTAN ALLAZOUN STYLES
